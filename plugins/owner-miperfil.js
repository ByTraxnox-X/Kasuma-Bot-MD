...
let { name, mod, bots, registered, banned, regTime, age, warn } = global.db.data.users[who]
let { xp, max } = xpRange(user.level, global.multiplier)
...
handler.help = ['miperfil']
handler.tags = ['owner']
handler.command = ['miperfil'] 
handler.owner = true
