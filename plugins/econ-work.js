...
let handler = async (m, { conn, usedPrefix, command }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 3600000) throw `*Estas cansado* y por lo tanto hay que esperar *${msToTime(time - new Date())}* para volver a trabajar!`
